...
writeLines(as.character(tabla_md), "output/tables/ICT/tabla_cox_resumen_ict_2003.md")
...
# Exportar tabla (Asegúrate de tener la carpeta output/tables/ICT/ creada)
writeLines(as.character(tabla_md), "output/tables/ICT/tabla_cox_resumen_ict_2009.md")
...
# Exportar tabla (Asegúrate de tener la carpeta output/tables/ICT/ creada)
writeLines(as.character(tabla_md), "output/tables/ICT/tabla_cox_resumen_ict_2016.md")
